...
import { createVariantVersion } from '@/app/(dashboard)/students/[id]/documents/actions'
...
export function VariantEditor({
  ...
  const handleSave = () => {
    ...
    startTransition(async () => {
      const result = await createVariantVersion(studentId, masterId, {
